...
public class RendererParser
{
    ...
    public function parseRenderer(rendererXML:XML):Renderer
    {
    ...
    private function parseClassBreaksRenderer(rendererXML:XML):Renderer
    {
    ...
    private function parseUniqueValueRenderer(rendererXML:XML):Renderer
    {

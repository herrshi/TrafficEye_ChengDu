...
public class UIManager extends EventDispatcher
{
    ...
    private function setViewerStyle():void
    {
		...
		var applicationBackgroundAlpha:Number;
		...
		applicationBackgroundAlpha = configData.applicationBackgroundAlpha; 
        ...
        if (cssStyleDeclarationApplication)
        {
            ...
            cssStyleDeclarationApplication.setStyle("backgroundAlpha", applicationBackgroundAlpha);
        ...
        if (cssStyleDeclarationApplicationWindowed)
        {
            ...
            cssStyleDeclarationApplicationWindowed.setStyle("backgroundAlpha", applicationBackgroundAlpha);

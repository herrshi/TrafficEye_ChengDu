package com.esri.viewer.components.treePolicePDA.treePolicePDAClasses
{
	...
	import com.esri.viewer.components.treePolice.treePoliceClasses.TreePoliceItem;
	
	public class TreePolicePDAItemRenderer extends TreeItemRenderer
	{
		...
		override protected function commitProperties():void
		{
			...
			if (data is TreePolicePDAItem)
			{
				var item:TreePolicePDAItem = TreePolicePDAItem(data);
